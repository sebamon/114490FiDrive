...
function CapturarArchivo(){
    ...
    $nuevaruta='../amarchivo/amarchivo.php?clave=1&parametro='+$ruta.value;
    }
    else
    {
        if($accion=='compartirarchivo'){
            $nuevaruta='../amarchivo/compartirarchivo.php?parametro='+$ruta.value;
        }
    }
    //echo ($nuevaruta);
...
function Encriptar()
{
    ...
    var $encriptada=md5($clave);
 //   document.getElementById('clave').value=$encriptada; PARA ACTIVAR REVISAR DONDE SE ENCRIPTA LA CONTRASEÑA
    return true;
}
