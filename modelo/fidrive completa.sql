...
INSERT INTO `usuario` (`idusuario`, `usnombre`, `usapellido`, `uslogin`, `usmail`,`usclave`, `usactivo`) VALUES
(1, 'admin', 'administrador', 'FiDrive','fidrive@fidrive.com', 'admin',1),
